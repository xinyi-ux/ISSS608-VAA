...
[**FunnelPlotR**]{.underline} package uses ggplot to generate funnel plots. It requires a numerator (events of interest), denominator (population to be considered) and group. The key arguments selected for customisation are:
...
# References
   ...
   - [Funnel Plots](https://nhs-r-community.github.io/FunnelPlotR/index.html)
