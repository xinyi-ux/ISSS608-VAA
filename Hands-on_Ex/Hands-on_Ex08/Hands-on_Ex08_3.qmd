...
n this in-class exercise, you will gain hands-on experience on using appropriate R methods to plot analytical maps.
...
-   variable name (as character, in quotes)
...
## 5.4 A percentile mapping function
...
## 5.5 Test drive the percentile mapping function
...
## 6.1 Creating the boxbreaks function
...
## 6.2 Creating the get.var function
...
## 6.3 Test drive the newly created function
